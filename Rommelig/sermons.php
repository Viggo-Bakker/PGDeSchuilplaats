...
try {
  if (isset($_POST['search_sermon'])) {    //if search term is set
    ...
    $query_show = $db->prepare("SELECT * FROM sermons ORDER BY date DESC LIMIT 5 OFFSET :offset");
    $query_show->bindParam("offset", $offset, PDO::PARAM_INT);
  }
  $query_show->execute();
    ...
    <section id="sermons">
      ...
      <div id="sermon-list">
        ...
        <div id="show-other-container">
          ...
          <p class="show-other"><?php echo "$offset / " . ($offset + 5); ?></p>
